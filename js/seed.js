...
(function (RooHQ) {
  ...
  var TEMPLATES = [
    ...
    { key: 'put-away-laundry', title: 'Put away laundry', category: 'laundry', cadence: 'daily', dayIndex: 0, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'walk-roo-in-the-morning', title: 'Walk Roo in the morning', category: 'dog', cadence: 'daily', dayIndex: 0, timeOfDay: 'morning', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: 'Anna is home during the day.' },
    ...
    { key: 'clean-all-windowsills', title: 'Clean all windowsills', category: 'cleaning', cadence: 'weekly', dayIndex: 2, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'swap-hank-mops', title: 'Swap Hank mops', category: 'cleaning', cadence: 'weekly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: 'Hank is the robot mop/vacuum.' },
    { key: 'swap-hank-water', title: 'Swap Hank water', category: 'cleaning', cadence: 'weekly', dayIndex: 4, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: 'Hank is the robot mop/vacuum.' },
    { key: 'clean-downstairs-toilet-and-sink', title: 'Clean downstairs toilet and sink', category: 'cleaning', cadence: 'weekly', dayIndex: 0, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'clean-downstairs-toilet-surround', title: 'Clean downstairs toilet surround', category: 'cleaning', cadence: 'weekly', dayIndex: 1, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'clean-downstairs-toilet-mirror', title: 'Clean downstairs toilet mirror', category: 'cleaning', cadence: 'weekly', dayIndex: 2, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'clean-downstairs-floor', title: 'Clean downstairs floor', category: 'cleaning', cadence: 'weekly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'hoover-upstairs-landing', title: 'Hoover upstairs landing', category: 'cleaning', cadence: 'weekly', dayIndex: 5, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'clean-main-toilet-mirror', title: 'Clean main toilet mirror', category: 'cleaning', cadence: 'weekly', dayIndex: 2, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'mop-en-suite-floor', title: 'Mop en-suite floor', category: 'cleaning', cadence: 'weekly', dayIndex: 4, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'clean-en-suite-toilet-and-sink', title: 'Clean en-suite toilet and sink', category: 'cleaning', cadence: 'weekly', dayIndex: 5, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'clean-en-suite-mirror', title: 'Clean en-suite mirror', category: 'cleaning', cadence: 'weekly', dayIndex: 6, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'dust-venjakob-and-tv', title: 'Dust Venjakob and TV', category: 'cleaning', cadence: 'fortnightly', dayIndex: 0, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: 'Living room Venjakob furniture and TV unit.' },
    ...
    { key: 'hoover-sofa-and-chair-gaps', title: 'Hoover sofa and chair gaps', category: 'cleaning', cadence: 'fortnightly', dayIndex: 1, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 1, locked: false, seasonal: false, notes: null },
    ...
    { key: 'use-brush-on-stairs', title: 'Use brush on stairs', category: 'cleaning', cadence: 'fortnightly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: 'Stair edges and corners.' },
    { key: 'wipe-bannisters-and-slats', title: 'Wipe bannisters and slats', category: 'cleaning', cadence: 'fortnightly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 1, locked: false, seasonal: false, notes: null },
    { key: 'clean-main-bathroom-bathtub', title: 'Clean main bathroom bathtub', category: 'cleaning', cadence: 'fortnightly', dayIndex: 4, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'dust-master-bedroom-bedside-tables', title: 'Dust master bedroom bedside tables', category: 'cleaning', cadence: 'fortnightly', dayIndex: 6, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'dust-guest-bedroom-bedside-tables', title: 'Dust guest bedroom bedside tables', category: 'cleaning', cadence: 'fortnightly', dayIndex: 6, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 1, locked: false, seasonal: false, notes: null },
    ...
    { key: 'dust-garage-walls', title: 'Dust garage walls', category: 'cleaning', cadence: 'fortnightly', dayIndex: 5, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'edge-grass-front-and-back', title: 'Edge grass front and back', category: 'garden', cadence: 'fortnightly', dayIndex: 5, timeOfDay: 'midday', defaultAssignee: 'anna', slot: 1, locked: true, seasonal: true, notes: 'Alex has a severe grass allergy; Anna handles all grass cutting.' },
    { key: 'change-master-bedroom-bed-sheets', title: 'Change master bedroom bed sheets', category: 'laundry', cadence: 'fortnightly', dayIndex: 6, timeOfDay: 'morning', defaultAssignee: 'anna', slot: 0, locked: false, seasonal: false, notes: null },
    ...
    { key: 'clean-all-door-handles', title: 'Clean all door handles', category: 'cleaning', cadence: 'monthly', dayIndex: 2, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 1, locked: false, seasonal: false, notes: null },
    ...
    { key: 'clean-all-skirting-boards', title: 'Clean all skirting boards', category: 'cleaning', cadence: 'monthly', dayIndex: 4, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 2, locked: false, seasonal: false, notes: null },
    { key: 'clean-all-radiators', title: 'Clean all radiators', category: 'cleaning', cadence: 'monthly', dayIndex: 5, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 3, locked: false, seasonal: false, notes: null },
    { key: 'water-dining-room-plant', title: 'Water dining room plant', category: 'cleaning', cadence: 'monthly', dayIndex: 1, timeOfDay: 'morning', defaultAssignee: 'anna', slot: 3, locked: false, seasonal: false, notes: null },
    ...
    { key: 'hoover-downstairs-cupboard-shoe-and-stor', title: 'Hoover downstairs cupboard (shoe and storage)', category: 'cleaning', cadence: 'monthly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 0, locked: false, seasonal: false, notes: null },
    { key: 'wash-utility-floor-mat', title: 'Wash utility floor mat', category: 'laundry', cadence: 'monthly', dayIndex: 4, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 1, locked: false, seasonal: false, notes: null },
    ...
    { key: 'hoover-under-sofa-and-chairs', title: 'Hoover under sofa and chairs', category: 'cleaning', cadence: 'monthly', dayIndex: 5, timeOfDay: 'anytime', defaultAssignee: 'me', slot: 1, locked: false, seasonal: false, notes: null },
    { key: 'organise-airing-cupboard-shelf', title: 'Organise airing cupboard shelf', category: 'cleaning', cadence: 'monthly', dayIndex: 6, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 2, locked: false, seasonal: false, notes: null },
    ...
    { key: 'clean-washing-machine', title: 'Clean washing machine', category: 'laundry', cadence: 'quarterly', dayIndex: 3, timeOfDay: 'anytime', defaultAssignee: 'anna', slot: 6, locked: false, seasonal: false, notes: 'Run a maintenance/cleaning cycle.' },
  ...
  var RULES = {
    ...
    foodAndDishes: "Kitchen, dishes, dishwasher and bins default to Alex; the rest is shared, leaning to Anna.",
    sharing: "Every chore is a one-tap swap — owners are just a starting point.",
    mealPrep: "Sunday."
  };
